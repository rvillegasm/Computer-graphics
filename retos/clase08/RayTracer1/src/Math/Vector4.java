...
public class Vector4 {
    ...
    /**
     * Finds the angle between vector u and vector v
     * @param u Vector
     * @param v Vector
     * @return angle between u and v in degrees
     */
    public static double getAngle(Vector4 u, Vector4 v) {
        double cos = Vector4.dotProduct(u, v) / (u.magnitude())*(v.magnitude());
